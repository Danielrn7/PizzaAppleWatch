...
class IngredientesController: WKInterfaceController {
    ...
    @IBOutlet var esPiña: WKInterfaceSwitch!
    @IBOutlet var escebollamorada: WKInterfaceSwitch!
    ...
    @IBAction func changePiña(_ value: Bool) {
        if (value == true){
            contadorIngredientes += 1
    ...
    @IBAction func changecebollamorada(_ value: Bool) {
        if (value == true){
            contadorIngredientes += 1
            ingredientesSeleccionadoStr += "cebollamorada - "
        } else {
            contadorIngredientes -= 1
    ...
    override func contextForSegue(withIdentifier segueIdentifier: String) -> Any? {
        ...
        if (segueIdentifier == "ingredientesSegue"){
            ...
            datosPedido = DatosPedido(t: (datosPedido?.tamaño)!, m: (datosPedido?.masa)!, q: (datosPedido?.queso)!, i: ingredientesSeleccionadoStr)
